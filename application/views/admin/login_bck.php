      ...
      <div class="row-fluid" >
		<div style="width: 600px; margin: 0 auto ">
			<div class="well well-sm" style="background:black">
				...
				<h3 style="margin: 5px 0 0.4em 0; font-size: 21px; color: white; font-weight: bold"><?php echo $q_instansi->nama; ?></h3>
				<div style="color: white; font-size: 13px" class="clearfix"><?php echo $q_instansi->alamat; ?></div>
			 </div>
		</div>
